...
@pytest.mark.asyncio
async def test_kilo_rejects_image_content_naming_kilo(monkeypatch):
    monkeypatch.setenv("TUSKER_KILO_CLI_ENABLED", "true")
    ...
    assert "kilo-cli currently accepts text-only" in exc.value.message
