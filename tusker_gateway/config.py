...
DEFAULT_PROVIDER_REGISTRY: dict[str, ProviderConfig] = {
    ...
    "zai": ProviderConfig("zai", "bearer", "https://api.z.ai/api/paas", "/v4/chat/completions", auth_env="GLM_API_KEY"),
    "xiaomi": ProviderConfig("xiaomi", "bearer", "https://api.xiaomimimo.com", "/v1/chat/completions", auth_env="XIAOMI_MIMO_API_KEY"),
